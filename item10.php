...
<?php
    ...
    $sql = "SELECT picture,detail FROM books WHERE id = 10";
	...
	<table>
		...
		<td>
			...
			<input type="hidden" name="book" value="The Life-Changing Magic of Tidying Up: The Japanese Art of Decluttering and Organizing">
			<br>
